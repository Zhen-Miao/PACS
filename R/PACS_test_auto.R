...
#' Profile likelihood ratio test with PACS -- clean
#'
#' @importFrom tictoc tic
#' @importFrom tictoc toc
#' @importFrom parallel mclapply
...
#' @export
#'
pacs_test_sparse_clean <- function(covariate_meta.data, formula_full,
                             formula_null, pic_matrix,
                             n_peaks_per_round = NULL,
                             T_proportion_cutoff = 0.2,
                             cap_rates, par_initial_null = NULL,
  ...
  return(list(pacs_converged = NULL, pacs_p_val = p_val))
}

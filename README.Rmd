...
> **Python user?** A Python implementation is available at [pacs-py](https://github.com/Zhen-Miao/pacs-py), with AnnData/scanpy integration.
...
Miao, Z., Wang, J., Park, K., Kuang, D. and Kim, J. **Depth-corrected multi-factor dissection of chromatin accessibility for scATAC-seq data with PACS.** _Nature Communications_ 16, 346 (2025). https://doi.org/10.1038/s41467-024-55580-5
...
* [**pacs-py**](https://github.com/Zhen-Miao/pacs-py) -- Python implementation of PACS, with AnnData/scanpy integration
